  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100 flex flex-col items-center justify-center p-8">
      <div className="absolute top-4 right-4 flex items-center gap-3">
        {user ? (
          <>
            <span className="text-amber-800 text-sm">👤 {user}</span>
            <Button onClick={handleLogout} className="bg-amber-600 hover:bg-amber-700 text-white text-sm px-3 py-1 h-auto">
              登出
            </Button>
          </>
        ) : (
      ...
      <AuthModal open={showAuth} onClose={() => setShowAuth(false)} onLogin={setUser} />
      ...
      <div className="mb-8 flex items-center gap-4">
        ...
        {gameEnded && (
          <motion.div
            ...
            className={`text-2xl text-center p-4 rounded-lg shadow-lg border-2 ${
              score > 0
